 ...
 * 
 */
@WebServiceClient(name = "Calculator", targetNamespace = "http://tempuri.org/",
    ...
    extends Service
{
    ...
    static {
        CALCULATOR_WSDL_LOCATION = com.soap.calculation.Calculator.class.getClassLoader().getResource("calculation.wsdl");
        WebServiceException e = null;
        if (CALCULATOR_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'http://www.dneonline.com/calculator.asmx?WSDL' wsdl. Place the resource correctly in the classpath.");
        }
